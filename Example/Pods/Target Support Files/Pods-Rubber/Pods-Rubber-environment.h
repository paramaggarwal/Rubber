...
// Rubber
#define COCOAPODS_POD_AVAILABLE_Rubber
#define COCOAPODS_VERSION_MAJOR_Rubber 0
#define COCOAPODS_VERSION_MINOR_Rubber 1
#define COCOAPODS_VERSION_PATCH_Rubber 0
